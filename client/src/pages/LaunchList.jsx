        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-2">
          <div className="">
            ...
            <p className="mb-3 max-w-[30rem] text-sm font-light hidden lg:block text-gray-400 dark:text-gray-400">
              Participate in ICOs on SAFE Launch.
            </p>
          </div>
          <button
                ...
                {currentLaunchpad.map((token, index) => (
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-400 mt-2">
                      Hard Cap
                      <p className="flex  gap-2 items-center font-black text-xl text-safemoon-dark dark:text-white">
                    ...
                    <div>
                      <div className="mt-2 pb-2 flex justify-between items-center border-b dark:border-gray-600">
                        Soft Cap <div>{token.soft_cap}</div>
                      </div>
                      <div className="mt-2 pb-2 flex justify-between items-center border-b dark:border-gray-600">
                        Liquidity <div>{token.lp_percent}%</div>
                      </div>
                      <div className="mt-2 pb-2 flex justify-between items-center border-b dark:border-gray-600">
                        Offered{" "}
                        <div>
                          {formatNumber(
                            Number(token.total_token_sale) -
                              Number(token.lp_jettons)
                          )}{" "}
                    ...
                    <div className="flex justify-between gap-4 mt-6 items-center">
                      {token.start ? (
                        <Timer startTime={token.start} endTime={token.end} />
                      ) : (
                        "TBA"
                      )}
                      <Link
                        to={`/safe-launch/${token._id}`}
